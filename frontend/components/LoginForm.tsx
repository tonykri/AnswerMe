...
export default function LoginForm(props: any) {
  ...
  async function handleSubmit(e: any) {
    ...
    await axios.post('https://localhost:8080/api/User/login', {
      Email: email,
      Password: password
    }).then(res => {
      console.log(res);
  ...
  return (
    <form onSubmit={handleSubmit} className="lg:w-1/2 mt-2">
      ...
      <button type="submit" className="text-white bg-blue-600 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign in</button>
