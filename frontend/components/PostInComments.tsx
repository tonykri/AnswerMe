...
export default function PostInComments(props: any) {
    ...
    function handleDelete(e: any) {
        axios.delete(`https://localhost:8080/api/Post/delete/${props.id}`, {
            headers: {
        ...
        >
            <div className="flex justify-between">
                ...
                {(props.user.email === localStorage.getItem('email')) && <div>
                    ...
                    {editMode ?
                        <button type="button" className="text-white bg-red-700 w-8 rounded-lg p-1 hover:bg-red-800 transition-all duration-100" onClick={(e) => { e.stopPropagation(); setEditMode(!editMode); setWrongInput("") }}>
                            <svg fill="none" stroke="currentColor" stroke-width="1.5" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
